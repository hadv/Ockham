...
mod tests {
    ...
    fn test_transaction_gas_limit() {
        use crate::crypto::{Hash, generate_keypair, sign};
        use crate::storage::Storage;
        use crate::types::{Block, Bytes, MAX_TX_GAS_LIMIT, QuorumCertificate, Transaction}; // Import trait for save_account
        ...
        {
            // Fund the sender
            let addr = crate::types::keccak256(pk.0.to_bytes());
            let address = crate::types::Address::from_slice(&addr[12..]);
            let account = crate::storage::AccountInfo {
                nonce: 0,
                balance: crate::types::U256::from(10_000_000_000_000_000_000u64), // 10 ETH
                code_hash: crate::crypto::Hash(crate::types::keccak256(&[]).0),   // Empty Code Hash
                code: None,
            };
        ...
        let mut block =
            Block::new_dummy(pk.clone(), 1, Hash::default(), QuorumCertificate::default());
